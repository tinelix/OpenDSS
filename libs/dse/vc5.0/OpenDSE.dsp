...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../include" /D "_NODEBUG" /D "WIN32" /D "_WINDOWS" /D "_MSVC" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib ../decoders/riffdec/vc5.0/out/bin/riffdec.lib /nologo /subsystem:windows /dll /machine:I386 /out:"out/bin/OpenDSE.dll"
