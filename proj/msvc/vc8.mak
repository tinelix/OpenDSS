...
LD_LIBS			= user32.lib $(CROCON_ROOT)\out\library\bin\crocon.lib $(OPENDSE_ROOT)\out\bin\opendse.lib

CC_FLAGS		= $(C_FLAGS) -I$(INC_DIR) -I$(LIBS_INC_DIR) -DWIN32 -DWINDOWS -DMSVC_GE_800
